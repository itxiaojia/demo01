...
public class DoPOSTParam {
    ...
    public static void main(String[] args) throws Exception {
        ...
        HttpPost httpPost = new HttpPost("http://sms.pyg.com/sms/sendSms");

        // 设置2个post参数，一个是scope、一个是q
        List<NameValuePair> parameters = new ArrayList<NameValuePair>(0);
        parameters.add(new BasicNameValuePair("phone_number", "18435743914"));
        parameters.add(new BasicNameValuePair("sign_name", "黑马"));
        parameters.add(new BasicNameValuePair("template_code", "SMS_147975981"));
