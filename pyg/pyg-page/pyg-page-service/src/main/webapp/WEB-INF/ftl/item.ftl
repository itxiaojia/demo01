...
<body ng-app="pyg" ng-controller="pageController" ng-init="num=1;loadSku()">
<!-- 头部栏位 -->
<#include "top.ftl">
    ...
    <div id="item">
        <div class="crumb-wrap">
            <ul class="sui-breadcrumb">
                ...
                <li class="active">${itemCat3.name}</li>
            </ul>
        </div>
        <!--product-info-->
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <#if (itemImages?size>0)>
                            <span class="jqzoom">
                                <img jqimg="${itemImages[0].url}" src="${itemImages[0].url}"
                    ...
                    <div id="specification" class="summary-wrap clearfix">
                        <#list specificationItems as specification>
                            <dl>
                                ...
                                <dd>
                                    <a href="javascript:;" class="{{isSelected('${specification.attributeName}','${value}')?'selected':''}}" ng-click="selectSpecification('${specification.attributeName}','${value}')">${value}<span title="点击取消选择">&nbsp;</span></a>
                                </dd>
                                </#list>
                            </dl>
                        </#list>
